...
Call log:
  - Expect "toHaveTitle" with timeout 10000ms
    11 × unexpected value "Online Shopping Site for Women, Men, Kids Fashion, Lifestyle & More."
...
- list:
  - listitem:
    - button "Sign in or join AJIO": Sign In / Join AJIO
  - listitem:
    - link "Customer Care":
      - /url: /selfcare
  - listitem:
    - button "Visit AJIOLUXE"
- img "Ajio Icon":
  - link "AJIO Home":
    - /url: /
    - img
  ...
  - list:
    ...
    - listitem:
      - link "KIDS MEN More":
        ...
        - button "MEN More"
    - listitem:
      - link "BEAUTY MEN More":
        - /url: https://www.ajio.com/s/beauty-5269-65820
        - text: BEAUTY
        - button "MEN More"
    - listitem:
      - link "HOME & KITCHEN MEN More":
        - /url: https://www.ajio.com/c/8312
        - text: HOME & KITCHEN
        - button "MEN More"
- img "Search AJIO":
  - textbox "Search AJIO"
- button "Search": 
- button "Sign in to use wishlist"
- link "Cart":
  - /url: /cart
  - img "Cart Icon": 
...
- region "Promotional Banner Carousel":
  - group "Slide 2 of 4":
    - img "Promotional banner for Reliance Retail and SBI offering UPTO 10% instant discount, featuring silver (prime) and red (base) cards. Click to know more."
    - link "NA":
...
- region "Promotional Banner Carousel":
  - group "Slide 2 of 5":
    - img "Nyrika Riwaah saree with zigzag pattern. Minimum seventy percent off."
    - link "Minimum forty percent off athletic shoes. Black and gold sneakers featured. Shop Adidas, Asics, and more.":
