...
- Name: checkout\checkout.spec.js >> CHECKOUT FUNCTIONALITY TESTS >> CHECKOUT_01 Verify first name field accepts input
- Location: tests\checkout\checkout.spec.js:13:5
