...
- Name: checkout\checkout.spec.js >> CHECKOUT FUNCTIONALITY TESTS >> CHECKOUT_15 Verify complete checkout form can be filled
- Location: tests\checkout\checkout.spec.js:189:9

# Error details

```
TypeError: checkout.fillContactInfo is not a function
```
...
```ts
  ...
  188 | 
  189 |         test(
  190 |             'CHECKOUT_15 Verify complete checkout form can be filled',
  191 |             async () => {
  192 | 
> 193 |                 await checkout.fillContactInfo(
      |                                ^ TypeError: checkout.fillContactInfo is not a function
  194 |                     'Akhilesh',
  195 |                     'Agashe',
  196 |                     'akhilesh@test.com',
  197 |                     '9876543210'
  198 |                 );
  199 | 
  200 |                 await checkout.fillAddress(
  201 |                     '123 Main Street',
  202 |                     'Mumbai',
  203 |                     'Maharashtra',
  204 |                     '400001'
